      ...
      <div className="container mx-auto px-5">
        <header className="flex flex-col lg:flex-row justify-between items-center gap-14 xl:gap-52 py-14 md:py-20 xl:h-[85vh]">
          <div className="">
            ...
            <p className="py-5 text-xl md:text-2xl font-medium text-gray-800">
        ...
        <main className="my-8">
          <section className="flex flex-col justify-center items-center gap-5">
            <h3 className="text-3xl">Guarda y Organiza tus Víveres, Recetas, Listas.</h3>
            <p className="lg:px-60 text-xl">Crea tus canastas desde cualquier lugar y organízalas como quieras. Puedes usarlos en cualquier dispositivo en cualquier momento: Tus canastas ahora puede vivir en su bolsillo.</p>
          ...
          <section  className="flex flex-col justify-center items-center gap-5 my-20">
            <h3 className="text-3xl">Exporta tus canastas</h3>
            <p className="lg:px-60 text-xl">Exporta y comparte tus canastas fácilmente con tus contactos en un formato accesible y práctico, para que todos vean tus creaciones..</p>
